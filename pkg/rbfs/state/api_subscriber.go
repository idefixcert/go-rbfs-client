 ...
 * @param optional nil or *SubscriberApiSubscribersGetOpts - Optional Parameters:
...
type SubscriberApiSubscribersGetOpts struct {
...
func (a *SubscriberApiService) SubscribersGet(ctx context.Context, localVarOptionals *SubscriberApiSubscribersGetOpts) ([]SubscriberSessionRef, *http.Response, error) {
	var (
...
Lists the subscriber history to examine why subscriber got disconnected in the past 24 hours.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SubscriberApiSubscribersHistoryGetOpts - Optional Parameters:
...
type SubscriberApiSubscribersHistoryGetOpts struct {
	SubscriberUserName        optional.String
	SubscriberUserNameMatches optional.String
	IfpName                   optional.String
	InnerVlan                 optional.Int32
...
func (a *SubscriberApiService) SubscribersHistoryGet(ctx context.Context, localVarOptionals *SubscriberApiSubscribersHistoryGetOpts) ([]SubscriberHistory, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *SubscriberApiService) SubscribersL2bsaIfpNameAnpAdjustedAccountingGet(ctx context.Context, ifpName string, anp int32) (SubscriberAdjustedAccounting, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *SubscriberApiService) SubscribersL2bsaIfpNameAnpDelete(ctx context.Context, ifpName string, anp int32) (*http.Response, error) {
	var (
...
*/
func (a *SubscriberApiService) SubscribersL2bsaIfpNameAnpGet(ctx context.Context, ifpName string, anp int32) (SubscriberSession, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *SubscriberApiService) SubscribersSubscriberIdAccessLineInfoGet(ctx context.Context, subscriberId int32) (AccessLineInfo, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return SubscriberAdjustedAccounting
*/
func (a *SubscriberApiService) SubscribersSubscriberIdAdjustedAccountingGet(ctx context.Context, subscriberId int32) (SubscriberAdjustedAccounting, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param subscriberId The subscriber ID.
 * @param optional nil or *SubscriberApiSubscribersSubscriberIdDeleteOpts - Optional Parameters:
     * @param "Force" (optional.Bool) -  Forces subscriber session termination.

*/

type SubscriberApiSubscribersSubscriberIdDeleteOpts struct {
	Force optional.Bool
}

func (a *SubscriberApiService) SubscribersSubscriberIdDelete(ctx context.Context, subscriberId int32, localVarOptionals *SubscriberApiSubscribersSubscriberIdDeleteOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SubscriberApiService Disable lawful interception for the specified subscriber.
...
*/
func (a *SubscriberApiService) SubscribersSubscriberIdDisableLIPost(ctx context.Context, subscriberId int32, id int32) (*http.Response, error) {
	var (
...
/*
SubscriberApiService Enable lawful interception for the specified subscriber.
...
*/
func (a *SubscriberApiService) SubscribersSubscriberIdEnableLIPost(ctx context.Context, subscriberId int32, id int32, direction string, medIp string, medPort int32, medInstance string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return SubscriberSession
*/
func (a *SubscriberApiService) SubscribersSubscriberIdGet(ctx context.Context, subscriberId int32) (SubscriberSession, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SubscriberApiSubscribersTerminatePostOpts - Optional Parameters:
     * @param "IfpName" (optional.String) -  The physical interface name.
     * @param "IflName" (optional.String) -  The name of the subscriber&#x27;s logical interface.
     * @param "OuterVlan" (optional.Int32) -  Outer VLAN tag.
     * @param "AnpVlan" (optional.Int32) -  ANP VLAN tag (for L2BSA subscribers).
...
type SubscriberApiSubscribersTerminatePostOpts struct {
	IfpName                   optional.String
	IflName                   optional.String
	OuterVlan                 optional.Int32
	AnpVlan                   optional.Int32
...
func (a *SubscriberApiService) SubscribersTerminatePost(ctx context.Context, localVarOptionals *SubscriberApiSubscribersTerminatePostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SubscriberApiService) SubscribersTestAaaGet(ctx context.Context) ([]TestAaaObject, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *SubscriberApiService) SubscribersTestAaaPost(ctx context.Context, body []TestAaaObject) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SubscriberApiService) SubscribersTestAaaPut(ctx context.Context, body []TestAaaObject) (*http.Response, error) {
	var (
...
*/
func (a *SubscriberApiService) SubscribersTestAaaSubscriberIdDelete(ctx context.Context, subscriberId int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SubscriberApiService) SubscribersTestAaaSubscriberIdPut(ctx context.Context, body TestAaaObject, subscriberId int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
